...
public interface TimeDistanceDomainRepository extends TimeDistanceRepository, TimeDistanceRepositoryCustom {
    ...
    @Modifying
    @Query(
            value = "INSERT INTO time_distance (mdn, biz_id, date, hour, distance, seconds, created_at, updated_at) " +
                    "VALUES (:#{#entity.car.mdn}, :#{#entity.biz.id}, :#{#entity.date}, :#{#entity.hour}, :#{#entity.distance}, :#{#entity.seconds}, NOW(), NOW()) " +
